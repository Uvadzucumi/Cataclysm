...
t_paper,
// Tree
t_tree, t_tree_young, t_underbrush, t_shrub,
t_root_wall,
t_wax, t_floor_wax,
t_fence_v, t_fence_h,
...
{_("empty space"),      '#', c_black,   2,
	mfb(transparent)},
{_("dirt"),	     '.', c_brown,   2,
	mfb(transparent)|mfb(diggable)},
{_("mound of dirt"),    '#', c_brown,   3,
	mfb(transparent)|mfb(diggable)},
{_("shallow pit"),	     '0', c_yellow,  8,
	mfb(transparent)|mfb(diggable)},
{_("pit"),              '0', c_brown,  10,
	mfb(transparent)|mfb(diggable)},
{_("spiked pit"),       '0', c_ltred,  10,
	mfb(transparent)|mfb(diggable)},
{_("rock floor"),       '.', c_ltgray,  2,
	mfb(transparent)},
{_("pile of rubble"),   '#', c_ltgray,  4,
	mfb(transparent)|mfb(rough)|mfb(diggable)},
{_("metal wreckage"),   '#', c_cyan,    5,
	mfb(transparent)|mfb(rough)|mfb(sharp)|mfb(container)},
{_("grass"),	     '.', c_green,   2,
	mfb(transparent)|mfb(diggable)},
{_("metal floor"),      '.', c_ltcyan,  2,
	mfb(transparent)},
{_("pavement"),	     '.', c_dkgray,  2,
	mfb(transparent)},
{_("yellow pavement"),  '.', c_yellow,  2,
	mfb(transparent)},
{_("sidewalk"),         '.', c_ltgray,  2,
	mfb(transparent)},
{_("floor"),	     '.', c_cyan,    2,
	mfb(transparent)|mfb(l_flammable)},
{_("metal grate"),      '#', c_dkgray,  2,
	mfb(transparent)},
{_("slime"),            '~', c_green,   6,
	mfb(transparent)|mfb(container)|mfb(flammable)},
{_("walkway"),          '#', c_yellow,  2,
	mfb(transparent)},
{_("half-built wall"),  '#', c_ltred,   4,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)},
{_("wooden wall"),      '#', c_ltred,   0,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("chipped wood wall"),'#', c_ltred,   0,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("broken wood wall"), '&', c_ltred,   0,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
	mfb(supports_roof)},
{_("wall"),             '|', c_ltgray,  0,
...
{_("wall"),             '-', c_ltgray,  0,
	mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("metal wall"),       '|', c_cyan,    0,
	mfb(noitem)|mfb(noitem)|mfb(supports_roof)},
{_("metal wall"),       '-', c_cyan,    0,
	mfb(noitem)|mfb(noitem)|mfb(supports_roof)},
{_("glass wall"),       '|', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{_("glass wall"),       '-', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{_("glass wall"),       '|', c_ltcyan,  0, // Alarmed
	mfb(transparent)|mfb(bashable)|mfb(alarmed)|mfb(noitem)|
        mfb(supports_roof)},
{_("glass wall"),       '-', c_ltcyan,  0, // Alarmed
	mfb(transparent)|mfb(bashable)|mfb(alarmed)|mfb(noitem)|
        mfb(supports_roof)},
{_("reinforced glass"), '|', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{_("reinforced glass"), '-', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(supports_roof)},
{_("metal bars"),       '"', c_ltgray,  0,
	mfb(transparent)|mfb(noitem)},
{_("closed wood door"), '+', c_brown,   0,
	mfb(bashable)|mfb(flammable)|mfb(door)|mfb(noitem)|mfb(supports_roof)},
{_("damaged wood door"),'&', c_brown,   0,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
        mfb(supports_roof)},
{_("open wood door"),  '\'', c_brown,   2,
	mfb(flammable)|mfb(transparent)|mfb(supports_roof)},
{_("closed wood door"), '+', c_brown,   0,	// Actually locked
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("closed wood door"), '+', c_brown,   0, // Locked and alarmed
	mfb(bashable)|mfb(flammable)|mfb(alarmed)|mfb(noitem)|
        mfb(supports_roof)},
{_("empty door frame"), '.', c_brown,   2,
	mfb(flammable)|mfb(transparent)|mfb(supports_roof)},
{_("boarded up door"),  '#', c_brown,   0,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("closed metal door"),'+', c_cyan,    0,
	mfb(noitem)|mfb(supports_roof)},
{_("open metal door"), '\'', c_cyan,    2,
	mfb(transparent)|mfb(supports_roof)},
{_("closed metal door"),'+', c_cyan,    0, // Actually locked
	mfb(noitem)|mfb(supports_roof)},
{_("closed glass door"),'+', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(door)|mfb(noitem)|mfb(supports_roof)},
{_("open glass door"), '\'', c_ltcyan,  2,
	mfb(transparent)|mfb(supports_roof)},
{_("bulletin board"),   '6', c_blue,    0,
	mfb(flammable)|mfb(noitem)},
{_("makeshift portcullis"), '&', c_cyan, 0,
	mfb(noitem)},
{_("window"),	     '"', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
        mfb(supports_roof)},
{_("window"),	     '"', c_ltcyan,  0, // Actually alarmed
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(alarmed)|mfb(noitem)|
        mfb(supports_roof)},
{_("empty window"),     '0', c_yellow,  8,
	mfb(transparent)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("window frame"),     '0', c_ltcyan,  8,
	mfb(transparent)|mfb(sharp)|mfb(flammable)|mfb(noitem)|
        mfb(supports_roof)},
{_("boarded up window"),'#', c_brown,   0,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("solid rock"),       '#', c_white,   0,
	mfb(noitem)|mfb(supports_roof)},
{_("odd fault"),        '#', c_magenta, 0,
	mfb(noitem)|mfb(supports_roof)},
{_("paper wall"),       '#', c_white,   0,
	mfb(bashable)|mfb(flammable)|mfb(noitem)},
{_("tree"),	     '7', c_green,   0,
	mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("young tree"),       '1', c_green,   0,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)},
{_("underbrush"),       '#', c_ltgreen, 6,
...
{_("root wall"),        '#', c_brown,   0,
	mfb(noitem)|mfb(supports_roof)},
{_("wax wall"),         '#', c_yellow,  0,
	mfb(container)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{_("wax floor"),        '.', c_yellow,  2,
	mfb(transparent)|mfb(l_flammable)},
{_("picket fence"),     '|', c_brown,   3,
	mfb(transparent)|mfb(diggable)|mfb(flammable)|mfb(noitem)},
{_("picket fence"),     '-', c_brown,   3,
	mfb(transparent)|mfb(diggable)|mfb(flammable)|mfb(noitem)},
{_("railing"),          '|', c_yellow,  3,
	mfb(transparent)|mfb(noitem)},
{_("railing"),          '-', c_yellow,  3,
	mfb(transparent)|mfb(noitem)},
{_("marloss bush"),     '1', c_dkgray,  0,
	mfb(transparent)|mfb(bashable)|mfb(flammable)},
{_("fungal bed"),       '#', c_dkgray,  3,
	mfb(transparent)|mfb(l_flammable)|mfb(diggable)},
{_("fungal tree"),      '7', c_dkgray,  0,
	mfb(flammable)|mfb(noitem)},
{_("shallow water"),    '~', c_ltblue,  5,
	mfb(transparent)|mfb(swimmable)},
{_("deep water"),       '~', c_blue,    0,
	mfb(transparent)|mfb(swimmable)},
{_("sewage"),           '~', c_ltgreen, 6,
	mfb(transparent)|mfb(swimmable)},
{_("lava"),             '~', c_red,     0,
	mfb(transparent)},
{_("bed"),              '#', c_magenta, 5,
...
{_("sandbox"),          '#', c_yellow,  3,
	mfb(transparent)},
{_("slide"),            '#', c_ltcyan,  4,
	mfb(transparent)},
{_("monkey bars"),      '#', c_cyan,    4,
	mfb(transparent)},
{_("backboard"),        '7', c_red,     0,
	mfb(transparent)},
{_("bench"),            '#', c_brown,   3,
	mfb(transparent)|mfb(flammable)},
{_("table"),            '#', c_red,     4,
	mfb(transparent)|mfb(flammable)},
{_("pool table"),       '#', c_green,   4,
	mfb(transparent)|mfb(flammable)},
{_("gasoline pump"),    '&', c_red,     0,
	mfb(transparent)|mfb(explodes)|mfb(noitem)},
{_("smashed gas pump"), '&', c_ltred,   0,
	mfb(transparent)|mfb(noitem)},
{_("missile"),          '#', c_ltblue,  0,
	mfb(explodes)|mfb(noitem)},
{_("blown-out missile"),'#', c_ltgray,  0,
	mfb(noitem)},
{_("counter"),	     '#', c_blue,    4,
	mfb(transparent)|mfb(flammable)},
{_("radio tower"),      '&', c_ltgray,  0,
	mfb(noitem)},
{_("radio controls"),   '6', c_green,   0,
	mfb(transparent)|mfb(bashable)|mfb(noitem)},
{_("broken console"),   '6', c_ltgray,  0,
	mfb(transparent)|mfb(noitem)},
{_("computer console"), '6', c_blue,    0,
	mfb(transparent)|mfb(console)|mfb(noitem)},
{_("sewage pipe"),      '1', c_ltgray,  0,
	mfb(transparent)},
{_("sewage pump"),      '&', c_ltgray,  0,
	mfb(noitem)},
{_("centrifuge"),       '{', c_magenta, 0,
	mfb(transparent)},
{_("column"),           '1', c_ltgray,  0,
	mfb(flammable)},
{_("refrigerator"),     '{', c_ltcyan,  0,
	mfb(container)},
{_("dresser"),          '{', c_brown,   0,
	mfb(transparent)|mfb(container)|mfb(flammable)},
{_("display rack"),     '{', c_ltgray,  0,
        mfb(transparent)|mfb(container)|mfb(l_flammable)},
{_("book case"),        '{', c_brown,   0,
	mfb(container)|mfb(flammable)},
{_("dumpster"),	     '{', c_green,   0,
	mfb(container)},
{_("cloning vat"),      '0', c_ltcyan,  0,
	mfb(transparent)|mfb(bashable)|mfb(container)|mfb(sealed)},
{_("crate"),            '{', c_brown,   0,
        mfb(transparent)|mfb(bashable)|mfb(container)|mfb(sealed)|
        mfb(flammable)},
{_("open crate"),       '{', c_brown,   0,
        mfb(transparent)|mfb(bashable)|mfb(container)|mfb(flammable)},
{_("stairs down"),      '>', c_yellow,  2,
	mfb(transparent)|mfb(goes_down)|mfb(container)},
{_("stairs up"),        '<', c_yellow,  2,
	mfb(transparent)|mfb(goes_up)|mfb(container)},
{_("manhole"),          '>', c_dkgray,  2,
	mfb(transparent)|mfb(goes_down)|mfb(container)},
{_("ladder"),           '<', c_dkgray,  2,
	mfb(transparent)|mfb(goes_up)|mfb(container)},
{_("ladder"),           '>', c_dkgray,  2,
	mfb(transparent)|mfb(goes_down)|mfb(container)},
{_("downward slope"),   '>', c_brown,   2,
	mfb(transparent)|mfb(goes_down)|mfb(container)},
{_("upward slope"),     '<', c_brown,   2,
	mfb(transparent)|mfb(goes_up)|mfb(container)},
{_("rope leading up"),  '<', c_white,   2,
	mfb(transparent)|mfb(goes_up)},
{_("manhole cover"),    '0', c_dkgray,  2,
	mfb(transparent)},
{_("card reader"),	     '6', c_pink,    0,	// Science
	mfb(noitem)},
{_("card reader"),	     '6', c_pink,    0,	// Military
	mfb(noitem)},
{_("broken card reader"),'6',c_ltgray,  0,
	mfb(noitem)},
{_("slot machine"),     '6', c_green,   0,
	mfb(bashable)|mfb(noitem)},
{_("elevator controls"),'6', c_ltblue,  0,
	mfb(noitem)},
{_("powerless controls"),'6',c_ltgray,  0,
	mfb(noitem)},
{_("elevator"),         '.', c_magenta, 2,
	0},
{_("dark pedestal"),    '&', c_dkgray,  0,
	mfb(transparent)},
{_("light pedestal"),   '&', c_white,   0,
	mfb(transparent)},
{_("red stone"),        '#', c_red,     0,
	0},
{_("green stone"),      '#', c_green,   0,
	0},
{_("blue stone"),       '#', c_blue,    0,
	0},
{_("red floor"),        '.', c_red,     2,
	mfb(transparent)},
{_("green floor"),      '.', c_green,   2,
	mfb(transparent)},
{_("blue floor"),       '.', c_blue,    2,
	mfb(transparent)},
{_("yellow switch"),    '6', c_yellow,  0,
	mfb(transparent)},
{_("cyan switch"),      '6', c_cyan,    0,
	mfb(transparent)},
{_("purple switch"),    '6', c_magenta, 0,
	mfb(transparent)},
{_("checkered switch"), '6', c_white,   0,
	mfb(transparent)}
